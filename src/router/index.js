...
export const constantRoutes = [
  ...
  },
  {
    ...
    children: [{
      ...
      meta: { title: '酒店设置', icon: 'dashboard' }
    }]
  },
  {
    path: '/room',
    ...
    name: 'Room',
    meta: { title: '房间设置', icon: 'example' },
    children: [
      {
        path: '/room/category',
        name: 'room-category',
        component: () => import('@/views/room/category/index'),
        meta: { title: '房间类型' }
      },
      {
        path: '/room/info',
    ...
    children: [
      {
        path: '/food/category',
        name: 'food-category',
        component: () => import('@/views/food/category/index'),
        meta: { title: '商品类型' }
      },
      {
        path: '/food/info',
        name: 'food-info',
        component: () => import('@/views/food/info/index'),
        meta: { title: '商品信息' }
      }
    ]
  },
